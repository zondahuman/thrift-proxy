package com.abin.lee.thrift.client.factory;

import com.abin.lee.thrift.client.exception.ThriftException;
import com.abin.lee.thrift.client.service.ThriftServerAddressProvider;
...
public class ThriftClientPoolFactory extends BasePoolableObjectFactory<TServiceClient> {
	...
	public TServiceClient makeObject() throws Exception {
		...
		String serviceName = serverAddressProvider.getService();
		System.out.println("serviceName="+serviceName);
		TProtocol tMultiplexedProtocol = new TMultiplexedProtocol(protocol, serviceName);
		TServiceClient client = this.clientFactory.getClient(tMultiplexedProtocol);
		transport.open();
		if (callback != null) {
			try {
